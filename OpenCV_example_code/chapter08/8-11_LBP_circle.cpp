...
# All rights reserved.
#
# @Filename: 8-11_LBP_circle.cpp
# @Version：V1.0
# @Author: Frank Liu - frankliu624@gmail.com
# @Description: 圆形LBP特征
# @Create Time: 2018-10-28 13:01:30
# @Last Modified: 2018-10-28 13:01:30
***********************************************/
    ...
    for(int n = 0; n < neighbors; ++n)
    {
        ...
        for(int i = radius; i < src.rows-radius; ++i) 
        {
            for(int j = radius; j < src.cols-radius; ++j)
            {
                ...
                // 限定浮点精度，生成输出图像
                dst.at<int>(i-radius, j-radius) += (t > src.at<_Tp>(i,j) || std::abs(t-src.at<_Tp>(i,j)) 
